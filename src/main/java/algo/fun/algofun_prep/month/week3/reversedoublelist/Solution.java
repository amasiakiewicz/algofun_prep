package algo.fun.algofun_prep.month.week3.reversedoublelist;
...
class Result {
    ...
    public static DoublyLinkedListNode reverse(DoublyLinkedListNode llist) {
        ...
        while (nextNode != null) {
            final DoublyLinkedListNode furtherNode = nextNode.next;
            nextNode.next = llist;
            nextNode.prev = furtherNode;
            
            llist = nextNode;
            nextNode = furtherNode;
        }
